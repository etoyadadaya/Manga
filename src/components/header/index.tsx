...
const Header: FC<IHeader> = ({toggleMenu, activeEpisode, setEpisode}) => {
  return (
      <div className={styles.header}>
        <div className={styles.chapterSelector}>
          ...
          <div className={styles.episodeSelector}>
            <button onClick={() => setEpisode(activeEpisode--)} className={styles.episodeBtn}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.4 16.7998L9.60001 11.9998L14.4 7.19981" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </button>
            <p className={styles.episodeNumber}>Номер эпизода: {activeEpisode}</p>
            <button onClick={() => setEpisode(activeEpisode++)} className={styles.episodeBtn}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
